...
define([
    ...
    console.log('ninjaCharts 0.2.1 loaded. Using d3 version', d3.version);
    ...
    d3.ninja.histogram = function module() {
        var margin = defaultValues.margin,
        ...
        function chart(selection) {
            selection.each(function (data) {
                ...
                x.rangeRoundBands([0, width - margin.left - margin.right], .1);
                ...
                var bar = svg.select('.bars').selectAll('.bars').data(data);
...
//                    .attr('transform', 'translate('+x.range()[0] + x(0) +', 0)')
        ...
        chart.centreTheChartOnZero = function (_) {
            if (!arguments.length) return centreTheChartOnZero;
